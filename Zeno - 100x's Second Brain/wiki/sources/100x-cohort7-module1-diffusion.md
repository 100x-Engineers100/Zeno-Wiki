...
> [!note] Scope Update
> This page now covers **only L01–L04 and L07** — the lectures not yet replaced by individual lecture sources.
> L05–L06 and L08–L12 are fully covered by dedicated source pages. See [[wiki/index.md]] under Sources for the full individual lecture list.
...
This page covers: orientation, GenAI history (L01-L02), diffusion mechanics (L03), SDXL/ComfyUI fundamentals (L04), and video models in ComfyUI — WAN 2.1, Hunyuan (L07). ControlNet, IP Adapters, LoRA training, FreePik, UGC ads, and filmmaking are now in individual lecture source pages.
...
## Lectures Covered by This Page (L01–L04, L07 only)
| # | Title | Status |
|---|-------|--------|
| L1 | Orientation Session: Evolution of GenAI | Covered here |
| L2 | History of GenAI and TensorArt | Covered here |
| L3 | How Diffusion Works | Covered here |
| L4 | Intro to SDXL Concepts and ComfyUI | Covered here |
| L7 | Video Models in ComfyUI | Covered here |

## Lectures with Individual Source Pages (no longer in this page)
| # | New Source Page |
|---|----------------|
| L5 | [[100x-l05-controlnet-ip-adapters]] |
| L6 | [[100x-l06-flux-lora-training]] |
| L8 | [[100x-l08-comfyui-nodes-to-money]] |
| L9 | [[100x-l09-intro-freepik-spaces]] |
